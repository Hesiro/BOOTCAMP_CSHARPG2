    ...
    public class CustomerService : ICustomerService
    {
        public List<Customer> GetCustomers()
        {
            var customers = new List<Customer> { 
                ...
                new Customer{Id = 3, FirstName = "Jhon", SecondName = "Paul", LastName = "Garcia", SecondLastName = "Gomez", IsEnabled = true, DateLogin = DateTime.Now.AddDays(-30)},
                ...
                new Customer{Id = 7, FirstName = "Laura", SecondName = "Isabel", LastName = "Gonzales", SecondLastName = "Torres", IsEnabled = true, DateLogin = DateTime.Now.AddDays(-7)},
